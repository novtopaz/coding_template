...
<section id="a-question" class="sec-service-catch"><div class="area-contents">
	...
	function gopage(){
		...
		<div class="sec-diagnosis-in">
			<h4 class="ff-mincho"><span class="ff-crimson">Q2</span>相続人および遺産の概要を把握していますか？</h4>
			<p class="ff-mincho">YESかNOかを選択してください。</p>
			<div class="ff-crimson">
				<input type="radio" name="question" value="<?php echo esc_url( home_url( '/' ) ); ?>about/diagnosis/question2/#a-question" id="radio01" checked="checked"><label for="radio01" class="radio radio-yes">YES</label>
				<input type="radio" name="question" value="<?php echo esc_url( home_url( '/' ) ); ?>about/diagnosis/question5/#a-question" id="radio02"><label for="radio02" class="radio radio-no">NO</label>
			</div>
		</div>
		<div class="area-btn">
