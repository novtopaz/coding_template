...
<section id="a-question" class="sec-service-catch"><div class="area-contents">
	...
	function gopage(){
		...
		<div class="sec-diagnosis-in">
			<h4 class="ff-mincho"><span class="ff-crimson">Q5</span>相続税申告が必要ですか？</h4>
			<p class="ff-mincho">YESかNOかを選択してください。</p>
			<div class="ff-crimson">
				<input type="radio" name="question" value="<?php echo esc_url( home_url( '/' ) ); ?>about/diagnosis/answer5/#a-question" id="radio01" checked="checked"><label for="radio01" class="radio radio-yes">YES</label>
				<input type="radio" name="question" value="<?php echo esc_url( home_url( '/' ) ); ?>about/diagnosis/answer4/#a-question" id="radio02"><label for="radio02" class="radio radio-no">NO</label>
			</div>
		</div>
		<div class="area-btn">
