...
<section id="a-question" class="sec-service-catch"><div class="area-contents">
	...
	function gopage(){
		...
		<div class="sec-diagnosis-in">
			<h4 class="ff-mincho"><span class="ff-crimson">Q3</span>遺産分けの方法や割合が決まっていますか？</h4>
			<p class="ff-mincho">YESかNOかを選択してください。</p>
			<div class="ff-crimson">
				<input type="radio" name="question" value="<?php echo esc_url( home_url( '/' ) ); ?>about/diagnosis/question3/#a-question" id="radio01" checked="checked"><label for="radio01" class="radio radio-yes">YES</label>
