...
<section id="a-question" class="sec-service-catch"><div class="area-contents">
	...
	<div class="sec-diagnosis">
		<div class="sec-diagnosis-in">
			...
			<p class="ff-mincho">あなたに最適なサービス・プランは、<br><span>「相続登記おまかせプラン」<span>です！</span></span></p>
			<p class="txt">不動産の相続手続きをお手伝いするプランです。<br>相続登記は土地や財産の所有権を明確にするためにもとても大切です。<br>お客様のご要望に応じて幅広くご対応いたします。</p>
			<a href="<?php echo home_url('/about/#no03') ?>" class="btn btn-bg-black btn-size-440"><span class="pc-block">「相続登記おまかせプラン」について</span>詳しくはこちら<i aria-hidden="true" class="btn-ico btn-ico-pos-r"></i></a>
		</div>
