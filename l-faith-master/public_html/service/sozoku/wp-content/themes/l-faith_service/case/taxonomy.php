...
<div class="l-content">
	...
	<?php
		...
		$currentTerm = get_term( $termID, 'case_tax' );
		$currentTermName = $currentTerm->name;
	?>

	<ul class="p-listControl">
		<li class="p-listControl-all"><a href="<?php echo home_url('/case/'); ?>"><span>全て</span></a></li>
		<?php
			...
			foreach ($terms as $term) {
				...
				echo '<li class="'.$termClass.'"><a class="'.$activeItem.'" href="'.$termLink.'"><span>'.$termName.'</span></a></li>';
			}
		?>
	</ul>
			...
			<a class="imghover clearfix" href="<?php the_permalink(); ?>">
				...
				<div class="p-listCase-item-content is-matchHeightPC flL-pc">
					<div class="p-listCase-item-inner">
						...
						<?php if(!empty(get_field('case_lead'))) : ?>
